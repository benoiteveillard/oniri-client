/**
 * Webflow CSS Classes
 * A comprehensive list of Webflow-specific CSS classes organized by component type
 */
...
// HOW TO USE
/**
 * Import specific classes or groups as needed:
 *
 * import { DROPDOWN_CSS_CLASSES } from './utils/webflow-css.js';
 *
 * // Then use in your code
 * const dropdowns = document.querySelectorAll(`.${DROPDOWN_CSS_CLASSES.dropdown}`);
 *
 * // Or check if an element has a specific class
 * if (element.classList.contains(FORM_CSS_CLASSES.errorMessage)) {
 *   // Handle form error
 * }
 */
